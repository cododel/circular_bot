...
- [ ] **Очередь обработки с воркерами** — батч-обработка нескольких кружков с динамическим распределением CPU-ядер на основе реальной утилизации ресурсов, отображение очереди и прогресса каждого видео
